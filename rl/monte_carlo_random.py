...
def play_game(grid, policy):
    ...
    # we would neve end up at certain states, but we still want to measure their value
    ...
    states_and_rewards.reverse() # we want it to be in order of state visited
