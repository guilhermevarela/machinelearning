...
motivation: Unsupervised techniques: tSNE on book titles
...
from util import get_book_titles, get_stopwords
...
def my_tokenizer(s): 
	...
	tokens= [wordnet_lemmatizer.lemmatize(t) for t in tokens] # put ewords into baseform
