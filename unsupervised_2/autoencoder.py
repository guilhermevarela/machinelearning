...
motivation: Unsupervised techniques auto encoder + theano
...
class DNN(object):
	...
	def fit(self, X, Y, Xtest, Ytest, pretrain=True, learning_rate=0.01, mu=.99, reg=0*.1,epochs=1,batch_sz=100,show_fig=False):
		pretrain_epochs=1
		if not pretrain: 
			pretrain_epochs = 0 
